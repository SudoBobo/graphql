    ...
    local schemas = json.decode([[{
        "hero": {
            ...
            "fields": [
                ...
                { "name": "starship_model", "type": "string" }
            ]
        },
        "human": {
            "name": "human",
            ...
            "connections": [
                {
                    ...
                    "variants": [
                        ...
                        },
                        {
                            ...
                            "parts": [
                                {
                                    "source_field": "starship_model",
                                    "destination_field": "model"
                                }
                            ],
                            "index_name": "starship_model_index"
                        }
                    ]
                }
            ]
...
function union_testdata.init_spaces()
    ...
    box.once('test_space_init_spaces', function()
        ...
        box.space.starship_collection:create_index('starship_model_index',
        { type = 'tree', unique = false, parts = {3, 'string' }}
        )
    end)
end
...
function union_testdata.fill_test_data(shard)
    ...
    shard.starship_collection:replace(
    { 1827767717, 'hero_id_3', 'X-Wing', "NEW"})

    shard.starship_collection:replace(
    { 1827767717, 'hero_id_1', 'Falcon-42', "NEW"})
end
